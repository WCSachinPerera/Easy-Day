  ...
  <nav>
    <div class="navdiv">
      ...
      <ul>
        ...
        <button><a href="Login02.php">Log In</a></button>
      </ul>
    </div>
  </nav>
  <div class="form">
    <form action="Signup02handler.php" method="post">
      <h1>Sign Up with Easy Day</h1>
      <input type="text" name="Fname" placeholder="First Name" required />
      <input type="text" name="Lname" placeholder="Last Name" />
      <input type="text" name="Email" placeholder="Email" required />
      <input type="text" name="Cno" placeholder="Contact Number" maxlength="10" required />
    ...
    <p>Already have an account? <a href="Login02.php">Log in</a></p>
  </div>
  <br /><br /><br />
  <footer class="footer">
